...
| **Key Vault** | Soft delete enabled, purge protection **enabled by default**; any disposable-demo opt-out is explicit and irreversible | 7-day soft delete + retained deleted vault names | `key-vault.bicep:42-49` |
